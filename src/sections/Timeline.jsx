...
export default function Timeline() {
  return (
    ...
    >
      <div className="relative border-l border-white/10 ml-4 md:ml-8 pl-8 md:pl-12 flex flex-col gap-16 py-4">
        {cvData.experience.map((exp, idx) => (
          <div key={idx} className="relative group">
            {/* Timeline Node Point */}
            <div className="absolute -left-[45px] md:-left-[61px] top-1.5 w-[25px] h-[25px] rounded-full border-4 border-[#030014] bg-[#0b0521] flex items-center justify-center group-hover:border-violet-500 transition-colors duration-300">
            ...
            {/* Experience Panel */}
            <div className="glass-panel p-6 md:p-8 rounded-3xl relative overflow-hidden glass-panel-hover">
              ...
              <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
                <div>
                  <h3 className="text-xl md:text-2xl font-bold text-white group-hover:text-violet-300 transition-colors duration-300">
                    {exp.role}
                  </h3>
              ...
              <ul className="flex flex-col gap-3">
                {exp.highlights.map((bullet, bIdx) => (
                  <li key={bIdx} className="flex items-start gap-3 text-xs sm:text-sm text-gray-400 leading-relaxed font-light">
