  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <div className="lg:col-span-4 flex flex-col gap-2 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
          {cvData.projects.map((project, idx) => {
            ...
            return (
              <button
                ...
                className={`w-full text-left p-4 md:p-5 rounded-2xl border transition-all duration-300 relative group overflow-hidden ${
                  isActive 
              ...
              >
                ...
                <div className="flex justify-between items-start gap-2">
                  <span className={`text-[10px] uppercase tracking-widest font-semibold ${isActive ? 'text-violet-400' : 'text-gray-500'}`}>
                ...
                <h4 className={`text-sm md:text-base font-bold mt-1.5 leading-snug transition-colors duration-200 ${isActive ? 'text-white' : 'text-gray-400 group-hover:text-gray-200'}`}>
                  {project.title}
                </h4>
              </button>
            );
        ...
        <div className="lg:col-span-8 flex">
          <div className="glass-panel w-full p-6 md:p-8 rounded-3xl relative overflow-hidden flex flex-col justify-between">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4 border-b border-white/5 pb-4 mb-6">
                    <div>
                      ...
                      <h3 className="text-xl md:text-2xl font-extrabold text-white mt-2 tracking-tight">
                        {activeProject.title}
                      </h3>
                    </div>
                  ...
                  {/* Summary Text */}
                  <p className="text-gray-400 text-xs sm:text-sm md:text-base leading-relaxed mb-6 font-light">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {activeProject.details.map((detail, dIdx) => (
                        <div key={dIdx} className="flex items-start gap-2.5 bg-white/[0.01] border border-white/5 p-3.5 rounded-2xl hover:border-white/10 transition-colors duration-200">
                ...
                <div className="border-t border-white/5 pt-5 mt-6">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {activeProject.tech.map((tech, tIdx) => (
                      <span 
                        key={tIdx} 
                        className="px-2.5 py-1 text-[11px] font-mono rounded-lg bg-violet-600/10 text-violet-300 border border-violet-500/20"
                      >
                        {tech}
                      </span>
                    ))}
