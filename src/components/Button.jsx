...
export default function Button({ 
  ...
  const variants = {
    ...
    secondary: "glass-panel text-white hover:bg-white/10 hover:border-white/20 border-white/8",
    tertiary: "text-gray-400 hover:text-white transition-colors duration-200"
  };
